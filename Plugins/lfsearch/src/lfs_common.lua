  ...
  Items.proc = function(hDlg, msg, param1, param2)
    if msg == F.DN_BTNCLICK then
      if param1 == Pos.btnHighlight then
        ...
        if color then hColor0 = color; hDlg:send("DM_REDRAW"); end
      elseif param1 == Pos.btnGrepLNum1 then
        local color = far.ColorDialog(hColor1, "FCD_RGB")
        if color then hColor1 = color; hDlg:send("DM_REDRAW"); end
      elseif param1 == Pos.btnGrepLNum2 then
        local color = far.ColorDialog(hColor2, "FCD_RGB")
        if color then hColor2 = color; hDlg:send("DM_REDRAW"); end
      end
