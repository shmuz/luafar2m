  ...
  read_globals = {
      ...
      fields = {
        ...
        ["Flags"] = {
          fields = {
            ...
            "DM_LISTUPDATE", "DM_MOVEDIALOG", "DM_REDRAW", "DM_RESIZEDIALOG", "DM_SET3STATE", "DM_SETREADONLY",
            ...
            "PF_VIEWER", "PKF_ALT", "PKF_CONTROL", "PKF_PREPROCESS", "PKF_SHIFT",
    ...
    ["win"] = {
      fields = {
        ...
        "ExpandEnv", "ExtractKey", "FileTimeToLocalFileTime", "FileTimeToSystemTime", "GetACP",
