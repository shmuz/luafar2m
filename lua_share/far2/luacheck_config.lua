  ...
  read_globals = {
    ...
    ["far"] = {
      fields = {
        ...
        "Execute", "ExecuteLibrary", "FarMacroCallToLua", "FindPlugin", "Flags", "ForcedLoadPlugin",
        ...
        "GetPluginDirList", "GetPlugins", "GetReparsePointInfo", "Guids", "InputBox", "InputRecordToKey",
